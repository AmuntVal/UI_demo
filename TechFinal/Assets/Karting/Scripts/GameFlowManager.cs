...
{
    [Header("LevelID")]
    [Tooltip("This int is artificially added to remind playerprefs which scene you are experiencing and which one is going to be loaded")]
        ...
        if (gameState != GameState.Play)
        {
            ...
            if(elapsedTimeBeforeEndScene >= endSceneLoadDelay)
            {
                ...
                if (Time.time >= m_TimeLoadEndGameScene)
                {
                    ...
                    //PlayerPrefs.SetInt("SecondLeft", SecondLeft);
                    PlayerPrefs.SetInt("Level", currentLevel);
                    PlayerPrefs.SetInt("SecondLeft",(int) m_TimeManager.TimeRemaining);
